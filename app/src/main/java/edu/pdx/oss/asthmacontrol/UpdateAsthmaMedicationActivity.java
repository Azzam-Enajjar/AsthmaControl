...
public class UpdateAsthmaMedicationActivity extends AppCompatActivity {
    EditText DATE_TEXT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_asthma_medication);
        ...
        dataAdapter.setDropDownViewResource(R.layout.activity_update_asthma_medication);
        ...
        IMAGE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(UpdateAsthmaMedicationActivity.this, listener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        ADD_DATE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor CR = dop1.getAllDatesFromAsthmaMedicationTable(dop1);
                if(CR.getCount()>0){
                    CR.moveToFirst();
                ...
                dop2.insertDateForAsthmaMedication(dop2, logDate);
                li.add(logDate);
        ...
        DELETE_ALL_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseOperations dop = new DatabaseOperations(ctx);
                dop.deleteAllFromAsthmaMedication(dop);
            }
        });
