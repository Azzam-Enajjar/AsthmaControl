...
public class TableData {
    ...
    public static abstract class TableInfo implements BaseColumns{
        ...
        public static final String ASTHMA_TIME_DATE ="log_date";

        public static final String ASTHMA_BREATH_TABLE = "asthmaBreath";
        public static final String ASTHMA_BREATH_DATE ="log_date";

        public static final String ASTHMA_SYMPTOMS_TABLE = "asthmaSymptoms";
        public static final String ASTHMA_SYMPTOMS_DATE ="log_date";

        public static final String ASTHMA_MEDICATION_TABLE = "asthmaMedication";
        public static final String ASTHMA_MEDICATION_DATE ="log_date";
    }
}
