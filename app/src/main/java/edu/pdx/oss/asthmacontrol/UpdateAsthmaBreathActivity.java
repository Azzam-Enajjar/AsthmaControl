...
public class UpdateAsthmaBreathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_asthma_breath);
        ...
        IMAGE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(UpdateAsthmaBreathActivity.this, listener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        ADD_DATE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor CR = dop1.getAllDatesFromAsthmaBreathTable(dop1);
                if(CR.getCount()>0){
                    CR.moveToFirst();
                ...
                dop2.insertDateForAsthmaBreath(dop2, logDate);
                li.add(logDate);
        ...
        DELETE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((pos != null) && (pos >=0)) {
                    ...
                    dop.deleteDateFromAsthmaBreath(dop, logDate);
                    li.remove(pos);
                    displayDataOnGridView();
                    pos = pos - 1;
        ...
        SHOW_FOUR_WEEKS_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseOperations dop = new DatabaseOperations(ctx);
                try {
                    Cursor CR = dop.getPastFourWeeksFromAsthmaBreath(dop);
                    li.clear();
                    if(CR.getCount()>0){
                        if (CR.moveToFirst()){
                            do {
                                String logDate = CR.getString(CR.getColumnIndex(TableData.TableInfo.ASTHMA_BREATH_DATE));
                                li.add(logDate);
                                GRIDVIEW.setAdapter(dataAdapter);
                            } while(CR.moveToNext());
                        }
        ...
        DELETE_ALL_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseOperations dop = new DatabaseOperations(ctx);
                dop.deleteAllFromAsthmaBreath(dop);
            }
        });
    ...
    public void displayDataOnGridView(){
        try {
            ...
            Cursor CR = SQ.rawQuery("SELECT * FROM " + TableData.TableInfo.ASTHMA_BREATH_TABLE + " ORDER BY " + TableData.TableInfo.ASTHMA_BREATH_DATE, null);
            li.clear();
            if(CR.getCount()>0){
                if (CR.moveToFirst()){
                    do {
