...
public class UpdateAsthmaSymptomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_asthma_symptoms);
        ...
        dataAdapter.setDropDownViewResource(R.layout.activity_update_asthma_symptoms);
        ...
        IMAGE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(UpdateAsthmaSymptomsActivity.this, listener, calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
        ...
        ADD_DATE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor CR = dop1.getAllDatesFromAsthmaSymptomsTable(dop1);
                if(CR.getCount()>0){
                    CR.moveToFirst();
                ...
                dop2.insertDateForAsthmaSymptoms(dop2, logDate);
                li.add(logDate);
        ...
        DELETE_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ((pos != null) && (pos >=0)) {
                    ...
                    dop.deleteDateFromAsthmaSymptoms(dop, logDate);
                    li.remove(pos);
                    displayDataOnGridView();
                    pos = pos - 1;
        ...
        SHOW_FOUR_WEEKS_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseOperations dop = new DatabaseOperations(ctx);
                try {
                    Cursor CR = dop.getPastFourWeeksFromAsthmaSymptoms(dop);
                    li.clear();
                    if(CR.getCount()>0){
                        if (CR.moveToFirst()){
                            do {
        ...
        DELETE_ALL_BUTTON.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatabaseOperations dop = new DatabaseOperations(ctx);
                dop.deleteAllFromAsthmaSymptoms(dop);
            }
        });
    ...
    public void displayDataOnGridView(){
        try {
            ...
            Cursor CR = SQ.rawQuery("SELECT * FROM " + TableData.TableInfo.ASTHMA_SYMPTOMS_TABLE + " ORDER BY " + TableData.TableInfo.ASTHMA_SYMPTOMS_DATE, null);
            li.clear();
            if(CR.getCount()>0){
                if (CR.moveToFirst()){
                    do {
                        String logDate = CR.getString(CR.getColumnIndex(TableData.TableInfo.ASTHMA_SYMPTOMS_DATE));
                        li.add(logDate);
                        GRIDVIEW.setAdapter(dataAdapter);
                    } while(CR.moveToNext());
                }
